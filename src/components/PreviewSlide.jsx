    ...
    <div className='mt-10 ml-10 w-4/5 mb-8'>
        ...
        <div className="space-x-2 gap-[358px] mt-12 text-sm flex items-center">
            <div className="space-x-2">
                ...
                <button className="bg-primary py-1 px-4 rounded-[4px] hover:text-primary hover:bg-white hover:border-primary hover:border text-white" onClick={() => navigate('#')}>
                &lt; Previous
                </button>
                <button className="bg-primary py-1 px-7 rounded-[4px] hover:text-primary hover:bg-white hover:border-primary hover:border text-white" onClick={() => navigate('#')}>
                  Next &gt;
                </button>
                <button className="bg-white py-1 px-4 rounded-[4px] hover:bg-primary hover:text-white border-[1px] border-primary text-primary" onClick={() => navigate('#')}>
                End &gt;&gt; 
