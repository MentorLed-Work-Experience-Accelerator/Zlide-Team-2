...
const Navbar = () => {
  return (
    <div className='fixed left-0 right-0 top-0 flex justify-between items-center px-[100px] py-6 bg-white z-50'>
      ...
      <button className="md:py-3 py-2 md:px-12 px-6 text-white bg-primary hover:bg-black hover:outline-black font-semibold outline outline-1 outline-primary rounded-md">
        Try for free
      </button>
    </div>
  )
