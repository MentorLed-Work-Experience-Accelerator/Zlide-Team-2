...
const ContentPasted = () => {
  ...
  <div className="fixed flex flex-col inset-0 justify-center items-center bg-[#717171] backdrop-blur-2xl z-50">
    <h1 className="text-black text-start text-3xl font-bold w-[60%] relative top-4">
      Here&apos;s your content
    </h1>
    <p className="text-[#ABBED2] w-[60%] relative top-4">
    ...
    <div className="flex justify-end gap-16 w-[60%]">
      <button className="text-blue-500 text-xl font-medium hover:outline-primary" onClick={() => navigate('/content')}>
        Edit Content
      </button>
      <button className="md:py-3 py-2 md:px-12 px-6 text-white bg-blue-500 hover:bg-black hover:outline-none font-medium outline outline-none rounded-md border-none w-[30%]" onClick={() => navigate('/slides')}>
        Generate Slides
      </button>
    </div>
  </div>
